...
class GraphQLQueryServiceTest {
    ...
    private Sequence mockSequence(String name, String displayName, int order, boolean active, int visibilityCount, String group) {
    ...
    class GetShowTests {
        ...
        void shouldReplaceSequencesWithGroups() {
            ...
            // We expect two entries: one for the group (replacing sequences in group), and the independent one
